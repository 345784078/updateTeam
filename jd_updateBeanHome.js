...
function showMsg() {
  return new Promise(async resolve => {
    try {
      await $.http.get({url: `https://purge.jsdelivr.net/gh/345784078/updateTeam@main/jd_updateBeanHome.json`}).then((resp) => {
...
async function writeFile() {
  await fs.writeFileSync('https://github.com/345784078/updateTeam/blob/master/jd_updateBeanHome.json', JSON.stringify($.codeInfo));
